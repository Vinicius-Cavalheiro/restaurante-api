...
import { entrada, saida, getEstoque, getEstoqueUnidade, getMovimentacoes, } from "../controllers/estoque.controller.js";
 ...
 */
estoqueRoutes.get("/movimentacoes", permitirPerfis("ADMIN"), getMovimentacoes);
/**
 * @openapi
 ...
 *         description: Erro interno do servidor
 */
estoqueRoutes.get("/unidade/:unidadeId", getEstoqueUnidade);
/**
 * @openapi
 ...
 *         description: Erro interno do servidor
 */
estoqueRoutes.get("/unidade/:unidadeId/produto/:produtoId", getEstoque);
/**
 * @openapi
 * /estoques/entrada:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
estoqueRoutes.post("/entrada", permitirPerfis("ADMIN"), entrada);
/**
 * @openapi
 * /estoques/saida:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
estoqueRoutes.post("/saida", permitirPerfis("ADMIN"), saida);
