...
import { create, updateStatus, list, } from "../controllers/pedido.controller.js";
import { pagar, } from "../controllers/pagamento.controller.js";
 ...
 */
pedidoRoutes.get("/", permitirPerfis("ADMIN", "GERENTE", "ATENDENTE"), list);
/**
 * @openapi
 * /pedidos:
 *   post:
 ...
 *         description: Erro interno do servidor
 */
pedidoRoutes.post("/:id/pagamento", pagar);
/**
 * @openapi
 * /pedidos/{id}/status:
 *   patch:
 ...
 *         description: Erro interno do servidor
 */
pedidoRoutes.patch("/:id/status", permitirPerfis("ADMIN", "GERENTE", "ATENDENTE"), updateStatus);
